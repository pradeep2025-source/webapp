        ...
        stage('Deploy via SSH') {
            steps {
                    sh '''
                        ...
                        scp -i -R /var/lib/jenkins/Docker.pem /var/lib/jenkins/workspace/k8s/my-webapp ubuntu@172.31.20.74:/home/ubuntu/
                        sudo -u jenkins ssh -i /var/lib/jenkins/Docker.pem ubuntu@172.31.20.74  'kubectl apply -f /home/ubuntu/deployment.yml'
